...
from test import test_do
from train import train_do
from arg_parser import args_process
from model_util import load_graph
...
if(ret_dict['task'] == 'train'):
    ...
    train_object = train_do(last, pattern, model_key, frozen_model_path, ckpt_path, \
    ...
    test_object = test_do(graph, model_key, frozen_model_path, frozen_model_name, num_class, target)
